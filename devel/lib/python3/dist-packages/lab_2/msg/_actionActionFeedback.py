...
"""autogenerated by genpy from lab_2/actionActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class actionActionFeedback(genpy.Message):
  _md5sum = "79b79405986eacb37011a599868746eb"
  _type = "lab_2/actionActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','lab_2/actionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = lab_2.msg.actionFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = lab_2.msg.actionFeedback()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.feedback.feeddback,) = _get_struct_q().unpack(str[start:end])
      return self
