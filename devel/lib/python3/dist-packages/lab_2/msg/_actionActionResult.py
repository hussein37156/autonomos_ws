...
"""autogenerated by genpy from lab_2/actionActionResult.msg. Do not edit."""
import codecs
import sys
...
class actionActionResult(genpy.Message):
  _md5sum = "cc8e83b56358e48fec2dbe48aeefe27c"
  _type = "lab_2/actionActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','lab_2/actionResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = lab_2.msg.actionResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = lab_2.msg.actionResult()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.result.response,) = _get_struct_q().unpack(str[start:end])
      return self
